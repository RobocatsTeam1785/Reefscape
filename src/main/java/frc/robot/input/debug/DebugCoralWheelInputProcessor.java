...
public class DebugCoralWheelInputProcessor extends InputProcessor implements Sendable {
    // subsystems
    ...
    // modes
    public final ModeState<CoralWheelMode> state;
    ...
    public DebugCoralWheelInputProcessor(final CoralWheel wheel, final CommandXboxController driver, final ModeState<CoralWheelMode> state, Function<ModeState<?>, BooleanSupplier> isModeActive) {
        super(isModeActive);
